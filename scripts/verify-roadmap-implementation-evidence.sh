...
require_pattern "P1 notification empty state usage" "native/ios-app/App/Views/Notifications/FireNotificationsViewController.swift" "title: \"暂无通知\""
...
require_pattern "P1 home create accessibility label" "native/ios-app/App/Views/Home/FireHomeView.swift" "accessibilityLabel[[:space:]]*=[[:space:]]*\"创建新话题\"|\\.accessibilityLabel\\(\"创建新话题\"\\)"
require_pattern "P1 home search accessibility label" "native/ios-app/App/Views/Home/FireHomeView.swift" "accessibilityLabel[[:space:]]*=[[:space:]]*\"搜索\"|\\.accessibilityLabel\\(\"搜索\"\\)"
...
require_pattern "P2 Android topic tree projection" "native/android-app/src/main/java/com/fire/app/ui/topicdetail/TopicDetailViewModel.kt" "TopicDetailPostRows\\.projectRows"
